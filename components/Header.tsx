        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a
              ...
              className={`inline-flex items-center gap-1 text-sm font-medium transition-colors duration-300 ${scrolled ? 'text-slate-400 hover:text-green-600' : 'text-white/60 hover:text-white'}`}
            >
              会社サイト
        ...
        <div className="md:hidden bg-white border-t border-slate-100 shadow-lg">
          <div className="px-4 py-3 space-y-1">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1 px-3 py-2 text-slate-400 hover:text-green-600 hover:bg-green-50 rounded-md text-sm font-medium transition-colors"
            >
              会社サイト
              <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
